...
adb shell cmd package install-existing com.google.android.apps.wellbeing						#Digital Well being
...
adb shell cmd package install-existing com.google.android.as.oss								#Private Compute Services
